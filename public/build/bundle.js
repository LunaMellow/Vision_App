    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "sidebar-top noselect svelte-71l8w5");
    			...
    			attr_dev(h40, "class", "item-name svelte-71l8w5");
    			add_location(h40, file, 51, 8, 1285);
    			attr_dev(h60, "class", "item-name color-grey svelte-71l8w5");
    			add_location(h60, file, 52, 8, 1330);
    			attr_dev(h61, "class", "item-message svelte-71l8w5");
    			add_location(h61, file, 53, 8, 1386);
    			attr_dev(div1, "class", "item-text svelte-71l8w5");
    			add_location(div1, file, 50, 7, 1253);
    			attr_dev(div2, "class", "items svelte-71l8w5");
    			add_location(div2, file, 49, 6, 1226);
    			add_location(li0, file, 48, 5, 1215);
    			attr_dev(h41, "class", "item-name svelte-71l8w5");
    			add_location(h41, file, 60, 8, 1550);
    			attr_dev(h62, "class", "item-name color-grey svelte-71l8w5");
    			add_location(h62, file, 61, 8, 1601);
    			attr_dev(h63, "class", "item-message svelte-71l8w5");
    			add_location(h63, file, 62, 8, 1669);
    			attr_dev(div3, "class", "item-text svelte-71l8w5");
    			add_location(div3, file, 59, 7, 1518);
    			attr_dev(div4, "class", "items svelte-71l8w5");
    			add_location(div4, file, 58, 6, 1491);
    			add_location(li1, file, 57, 5, 1480);
    			attr_dev(h42, "class", "item-name svelte-71l8w5");
    			add_location(h42, file, 69, 8, 1831);
    			attr_dev(h64, "class", "item-name color-grey svelte-71l8w5");
    			add_location(h64, file, 70, 8, 1878);
    			attr_dev(h65, "class", "item-message svelte-71l8w5");
    			add_location(h65, file, 71, 8, 1932);
    			attr_dev(div5, "class", "item-text svelte-71l8w5");
    			add_location(div5, file, 68, 7, 1799);
    			attr_dev(div6, "class", "items svelte-71l8w5");
    			add_location(div6, file, 67, 6, 1772);
    			add_location(li2, file, 66, 5, 1761);
    			attr_dev(h43, "class", "item-name svelte-71l8w5");
    			add_location(h43, file, 78, 8, 2095);
    			attr_dev(h66, "class", "item-name color-grey svelte-71l8w5");
    			add_location(h66, file, 79, 8, 2141);
    			attr_dev(h67, "class", "item-message svelte-71l8w5");
    			add_location(h67, file, 80, 8, 2206);
    			attr_dev(div7, "class", "item-text svelte-71l8w5");
    			add_location(div7, file, 77, 7, 2063);
    			attr_dev(div8, "class", "items svelte-71l8w5");
    			add_location(div8, file, 76, 6, 2036);
    			add_location(li3, file, 75, 5, 2025);
    			attr_dev(h44, "class", "item-name svelte-71l8w5");
    			add_location(h44, file, 87, 8, 2384);
    			attr_dev(h68, "class", "item-name color-grey svelte-71l8w5");
    			add_location(h68, file, 88, 8, 2424);
    			attr_dev(h69, "class", "item-message svelte-71l8w5");
    			add_location(h69, file, 89, 8, 2479);
    			attr_dev(div9, "class", "item-text svelte-71l8w5");
    			add_location(div9, file, 86, 7, 2352);
    			attr_dev(div10, "class", "items svelte-71l8w5");
    			add_location(div10, file, 85, 6, 2325);
    			add_location(li4, file, 84, 5, 2314);
    			attr_dev(h45, "class", "item-name svelte-71l8w5");
    			add_location(h45, file, 96, 8, 2641);
    			attr_dev(h610, "class", "item-name color-grey svelte-71l8w5");
    			add_location(h610, file, 97, 8, 2681);
    			attr_dev(h611, "class", "item-message svelte-71l8w5");
    			add_location(h611, file, 98, 8, 2738);
    			attr_dev(div11, "class", "item-text svelte-71l8w5");
    			add_location(div11, file, 95, 7, 2609);
    			attr_dev(div12, "class", "items svelte-71l8w5");
    			add_location(div12, file, 94, 6, 2582);
    			add_location(li5, file, 93, 5, 2571);
    			attr_dev(h46, "class", "item-name svelte-71l8w5");
    			add_location(h46, file, 105, 8, 2903);
    			set_style(span0, "font-weight", "bold");
    			add_location(span0, file, 106, 41, 2978);
    			attr_dev(h612, "class", "item-name color-grey svelte-71l8w5");
    			add_location(h612, file, 106, 8, 2945);
    			attr_dev(h613, "class", "item-message svelte-71l8w5");
    			add_location(h613, file, 107, 8, 3048);
    			attr_dev(div13, "class", "item-text svelte-71l8w5");
    			add_location(div13, file, 104, 7, 2871);
    			attr_dev(div14, "class", "items svelte-71l8w5");
    			add_location(div14, file, 103, 6, 2844);
    			add_location(li6, file, 102, 5, 2833);
    			attr_dev(h47, "class", "item-name svelte-71l8w5");
    			add_location(h47, file, 114, 8, 3229);
    			attr_dev(h614, "class", "item-name color-grey svelte-71l8w5");
    			add_location(h614, file, 115, 8, 3279);
    			attr_dev(h615, "class", "item-message svelte-71l8w5");
    			add_location(h615, file, 116, 8, 3358);
    			attr_dev(div15, "class", "item-text svelte-71l8w5");
    			add_location(div15, file, 113, 7, 3197);
    			attr_dev(div16, "class", "items svelte-71l8w5");
    			add_location(div16, file, 112, 6, 3170);
    			add_location(li7, file, 111, 5, 3159);
    			attr_dev(ul, "class", "cards fadein-2s svelte-71l8w5");
    			set_style(ul, "overflow-y", "scroll");
    			add_location(ul, file, 46, 4, 989);
    			attr_dev(div17, "class", "secondary-field noselect svelte-71l8w5");
    			add_location(div17, file, 45, 3, 946);
    			attr_dev(h616, "id", "app-version");
    			attr_dev(h616, "class", "svelte-71l8w5");
    			add_location(h616, file, 124, 4, 3584);
    			attr_dev(div18, "class", "searchbar noselect svelte-71l8w5");
    			add_location(div18, file, 122, 3, 3475);
    			attr_dev(div19, "class", "navigation-top noselect svelte-71l8w5");
    			add_location(div19, file, 126, 3, 3636);
    			attr_dev(div20, "class", "sidebar-right noselect svelte-71l8w5");
    			add_location(div20, file, 128, 3, 3687);
    			attr_dev(img0, "class", "logo svelte-71l8w5");
    			...
    			attr_dev(div25, "class", "socials svelte-71l8w5");
    			add_location(div25, file, 150, 7, 5242);
    			attr_dev(div26, "class", "main-top-right main-box svelte-71l8w5");
    			add_location(div26, file, 149, 6, 5054);
    			attr_dev(img3, "class", "slideshow svelte-71l8w5");
    			...
    			attr_dev(img4, "class", "slideshow svelte-71l8w5");
    			...
    			attr_dev(img5, "class", "slideshow svelte-71l8w5");
    			...
    			attr_dev(img6, "class", "slideshow svelte-71l8w5");
    			...
    			attr_dev(img7, "class", "slideshow svelte-71l8w5");
    			...
    			attr_dev(img8, "class", "slideshow svelte-71l8w5");
    			...
    			attr_dev(img9, "class", "slideshow svelte-71l8w5");
    			...
    			attr_dev(img10, "class", "slideshow svelte-71l8w5");
    			...
    			attr_dev(div27, "class", "wrapper svelte-71l8w5");
    			add_location(div27, file, 156, 7, 5806);
    			attr_dev(div28, "class", "main-middle-left main-box svelte-71l8w5");
    			add_location(div28, file, 155, 6, 5759);
    			attr_dev(div29, "class", "news svelte-71l8w5");
    			add_location(div29, file, 168, 7, 6945);
    			attr_dev(div30, "class", "main-middle-right main-box svelte-71l8w5");
    			add_location(div30, file, 167, 6, 6897);
    			attr_dev(div31, "class", "main-bottom main-box svelte-71l8w5");
    			add_location(div31, file, 172, 6, 6998);
    			attr_dev(div32, "class", "main-content svelte-71l8w5");
    			add_location(div32, file, 142, 5, 4809);
    			attr_dev(div33, "class", "main-field-container svelte-71l8w5");
    			add_location(div33, file, 141, 4, 4769);
    			attr_dev(div34, "class", "sidebar-right-bottom noselect svelte-71l8w5");
    			add_location(div34, file, 176, 3, 7069);
    			attr_dev(i4, "class", "fa fa-gear");
    			add_location(i4, file, 178, 71, 7232);
    			attr_dev(button4, "class", "sidebar-buttons fadein-6s svelte-71l8w5");
    			attr_dev(button4, "onclick", "showSettings()");
    			add_location(button4, file, 178, 4, 7165);
    			attr_dev(div35, "class", "bottombar-left noselect svelte-71l8w5");
    			add_location(div35, file, 177, 3, 7123);
    			attr_dev(img11, "class", "profilepicture fadein-6s svelte-71l8w5");
    			...
    			attr_dev(div36, "class", "profilepicture-container svelte-71l8w5");
    			add_location(div36, file, 181, 4, 7328);
    			attr_dev(h49, "class", "username-profile-field svelte-71l8w5");
    			add_location(h49, file, 185, 5, 7583);
    			attr_dev(h5, "class", "username-id-field svelte-71l8w5");
    			add_location(h5, file, 186, 5, 7635);
    			attr_dev(div37, "class", "profile-info fadein-6s svelte-71l8w5");
    			add_location(div37, file, 184, 4, 7541);
    			attr_dev(div38, "class", "bottombar-secondary noselect svelte-71l8w5");
    			add_location(div38, file, 180, 3, 7281);
    			attr_dev(div39, "class", "bottombar-main noselect svelte-71l8w5");
    			add_location(div39, file, 189, 3, 7700);
    			attr_dev(div40, "class", "bottombar-right noselect svelte-71l8w5");
    			add_location(div40, file, 190, 3, 7749);
    			attr_dev(div41, "class", "main-field noselect svelte-71l8w5");
    			add_location(div41, file, 140, 3, 4731);
    			attr_dev(body, "onload", "loadingAnimation()");
    			attr_dev(body, "class", "layout fadein-2s svelte-71l8w5");
    			add_location(body, file, 40, 1, 601);
    			attr_dev(main, "class", "svelte-71l8w5");
