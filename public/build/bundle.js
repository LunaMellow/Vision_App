    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file, 59, 5, 1990);
    			attr_dev(h40, "class", "item-name svelte-d79kef");
    			add_location(h40, file, 63, 8, 2225);
    			attr_dev(h61, "class", "item-name color-grey svelte-d79kef");
    			add_location(h61, file, 64, 8, 2270);
    			attr_dev(h62, "class", "item-message svelte-d79kef");
    			add_location(h62, file, 65, 8, 2326);
    			attr_dev(div6, "class", "item-text svelte-d79kef");
    			add_location(div6, file, 62, 7, 2193);
    			attr_dev(div7, "class", "items svelte-d79kef");
    			add_location(div7, file, 61, 6, 2166);
    			add_location(li0, file, 60, 5, 2155);
    			attr_dev(h41, "class", "item-name svelte-d79kef");
    			add_location(h41, file, 72, 8, 2490);
    			attr_dev(h63, "class", "item-name color-grey svelte-d79kef");
    			add_location(h63, file, 73, 8, 2541);
    			attr_dev(h64, "class", "item-message svelte-d79kef");
    			add_location(h64, file, 74, 8, 2609);
    			attr_dev(div8, "class", "item-text svelte-d79kef");
    			add_location(div8, file, 71, 7, 2458);
    			attr_dev(div9, "class", "items svelte-d79kef");
    			add_location(div9, file, 70, 6, 2431);
    			add_location(li1, file, 69, 5, 2420);
    			attr_dev(h42, "class", "item-name svelte-d79kef");
    			add_location(h42, file, 81, 8, 2771);
    			attr_dev(h65, "class", "item-name color-grey svelte-d79kef");
    			add_location(h65, file, 82, 8, 2818);
    			attr_dev(h66, "class", "item-message svelte-d79kef");
    			add_location(h66, file, 83, 8, 2872);
    			attr_dev(div10, "class", "item-text svelte-d79kef");
    			add_location(div10, file, 80, 7, 2739);
    			attr_dev(div11, "class", "items svelte-d79kef");
    			add_location(div11, file, 79, 6, 2712);
    			add_location(li2, file, 78, 5, 2701);
    			attr_dev(h43, "class", "item-name svelte-d79kef");
    			add_location(h43, file, 90, 8, 3035);
    			attr_dev(h67, "class", "item-name color-grey svelte-d79kef");
    			add_location(h67, file, 91, 8, 3081);
    			attr_dev(h68, "class", "item-message svelte-d79kef");
    			add_location(h68, file, 92, 8, 3146);
    			attr_dev(div12, "class", "item-text svelte-d79kef");
    			add_location(div12, file, 89, 7, 3003);
    			attr_dev(div13, "class", "items svelte-d79kef");
    			add_location(div13, file, 88, 6, 2976);
    			add_location(li3, file, 87, 5, 2965);
    			attr_dev(h44, "class", "item-name svelte-d79kef");
    			add_location(h44, file, 99, 8, 3324);
    			attr_dev(h69, "class", "item-name color-grey svelte-d79kef");
    			add_location(h69, file, 100, 8, 3364);
    			attr_dev(h610, "class", "item-message svelte-d79kef");
    			add_location(h610, file, 101, 8, 3419);
    			attr_dev(div14, "class", "item-text svelte-d79kef");
    			add_location(div14, file, 98, 7, 3292);
    			attr_dev(div15, "class", "items svelte-d79kef");
    			add_location(div15, file, 97, 6, 3265);
    			add_location(li4, file, 96, 5, 3254);
    			attr_dev(h45, "class", "item-name svelte-d79kef");
    			add_location(h45, file, 108, 8, 3581);
    			attr_dev(h611, "class", "item-name color-grey svelte-d79kef");
    			add_location(h611, file, 109, 8, 3621);
    			attr_dev(h612, "class", "item-message svelte-d79kef");
    			add_location(h612, file, 110, 8, 3678);
    			attr_dev(div16, "class", "item-text svelte-d79kef");
    			add_location(div16, file, 107, 7, 3549);
    			attr_dev(div17, "class", "items svelte-d79kef");
    			add_location(div17, file, 106, 6, 3522);
    			add_location(li5, file, 105, 5, 3511);
    			attr_dev(h46, "class", "item-name svelte-d79kef");
    			add_location(h46, file, 117, 8, 3843);
    			set_style(span5, "font-weight", "bold");
    			add_location(span5, file, 118, 41, 3918);
    			attr_dev(h613, "class", "item-name color-grey svelte-d79kef");
    			add_location(h613, file, 118, 8, 3885);
    			attr_dev(h614, "class", "item-message svelte-d79kef");
    			add_location(h614, file, 119, 8, 3988);
    			attr_dev(div18, "class", "item-text svelte-d79kef");
    			add_location(div18, file, 116, 7, 3811);
    			attr_dev(div19, "class", "items svelte-d79kef");
    			add_location(div19, file, 115, 6, 3784);
    			add_location(li6, file, 114, 5, 3773);
    			attr_dev(h47, "class", "item-name svelte-d79kef");
    			add_location(h47, file, 126, 8, 4169);
    			attr_dev(h615, "class", "item-name color-grey svelte-d79kef");
    			add_location(h615, file, 127, 8, 4219);
    			attr_dev(h616, "class", "item-message svelte-d79kef");
    			add_location(h616, file, 128, 8, 4298);
    			attr_dev(div20, "class", "item-text svelte-d79kef");
    			add_location(div20, file, 125, 7, 4137);
    			attr_dev(div21, "class", "items svelte-d79kef");
    			add_location(div21, file, 124, 6, 4110);
    			add_location(li7, file, 123, 5, 4099);
    			attr_dev(ul, "class", "cards fadein-2s svelte-d79kef");
    			add_location(ul, file, 58, 4, 1956);
    			attr_dev(div22, "class", "secondary-field noselect svelte-d79kef");
    			set_style(div22, "overflow-y", "scroll");
    			add_location(div22, file, 57, 3, 1886);
    			attr_dev(div23, "class", "main-content");
    			add_location(div23, file, 136, 5, 4493);
    			attr_dev(div24, "class", "main-field-container svelte-d79kef");
    			add_location(div24, file, 135, 4, 4453);
    			attr_dev(div25, "class", "main-field noselect svelte-d79kef");
    			add_location(div25, file, 134, 3, 4415);
    			attr_dev(div26, "class", "sidebar-right-bottom noselect svelte-d79kef");
    			add_location(div26, file, 140, 3, 4556);
    			attr_dev(i4, "class", "fa fa-gear");
    			add_location(i4, file, 142, 71, 4719);
    			attr_dev(button4, "class", "sidebar-buttons fadein-6s svelte-d79kef");
    			attr_dev(button4, "onclick", "showSettings()");
    			add_location(button4, file, 142, 4, 4652);
    			attr_dev(div27, "class", "bottombar-left noselect svelte-d79kef");
    			add_location(div27, file, 141, 3, 4610);
    			...
    			add_location(img1, file, 146, 5, 4859);
    			attr_dev(div28, "class", "profilepicture-container svelte-d79kef");
    			add_location(div28, file, 145, 4, 4815);
    			attr_dev(h48, "class", "username-profile-field svelte-d79kef");
    			add_location(h48, file, 149, 5, 5070);
    			attr_dev(h5, "class", "username-id-field svelte-d79kef");
    			add_location(h5, file, 150, 5, 5122);
    			attr_dev(div29, "class", "profile-info fadein-6s svelte-d79kef");
    			add_location(div29, file, 148, 4, 5028);
    			attr_dev(div30, "class", "bottombar-secondary noselect svelte-d79kef");
    			add_location(div30, file, 144, 3, 4768);
    			attr_dev(div31, "class", "bottombar-main noselect svelte-d79kef");
    			add_location(div31, file, 153, 3, 5187);
    			attr_dev(div32, "class", "bottombar-right noselect svelte-d79kef");
    			add_location(div32, file, 154, 3, 5236);
    			attr_dev(body, "onload", "startTime()");
    			attr_dev(body, "class", "layout fadein-2s svelte-d79kef");
    			add_location(body, file, 35, 1, 499);
    			attr_dev(main, "class", "svelte-d79kef");
    			add_location(main, file, 34, 0, 491);
    		},
