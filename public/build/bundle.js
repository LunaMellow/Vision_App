    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "sidebar-top noselect svelte-jta4um");
    			add_location(div0, file, 7, 2, 117);
    			attr_dev(div1, "class", "searchbar noselect svelte-jta4um");
    			add_location(div1, file, 9, 2, 163);
    			attr_dev(div2, "class", "navigation-top noselect svelte-jta4um");
    			add_location(div2, file, 13, 2, 283);
    			attr_dev(div3, "class", "sidebar-right noselect svelte-jta4um");
    			add_location(div3, file, 14, 2, 330);
    			attr_dev(img0, "class", "logo svelte-jta4um");
    			...
    			attr_dev(span0, "class", "tooltip fadein-2s svelte-jta4um");
    			add_location(span0, file, 16, 3, 417);
    			attr_dev(i0, "class", "fa fa-home");
    			add_location(i0, file, 19, 98, 786);
    			attr_dev(button0, "class", "sidebar-buttons fadein-3s svelte-jta4um");
    			add_location(button0, file, 19, 56, 744);
    			attr_dev(span1, "data-text", "Home");
    			attr_dev(span1, "class", "tooltip-sidebar-home svelte-jta4um");
    			add_location(span1, file, 19, 4, 692);
    			attr_dev(i1, "class", "fa fa-user");
    			add_location(i1, file, 20, 99, 928);
    			attr_dev(button1, "class", "sidebar-buttons fadein-4s svelte-jta4um");
    			add_location(button1, file, 20, 57, 886);
    			attr_dev(span2, "data-text", "About");
    			attr_dev(span2, "class", "tooltip-sidebar-user svelte-jta4um");
    			add_location(span2, file, 20, 4, 833);
    			attr_dev(i2, "class", "fa fa-book");
    			add_location(i2, file, 21, 102, 1073);
    			attr_dev(button2, "class", "sidebar-buttons fadein-5s svelte-jta4um");
    			add_location(button2, file, 21, 60, 1031);
    			attr_dev(span3, "data-text", "Projects");
    			attr_dev(span3, "class", "tooltip-sidebar-book svelte-jta4um");
    			add_location(span3, file, 21, 4, 975);
    			attr_dev(i3, "class", "fa fa-laptop");
    			add_location(i3, file, 22, 115, 1231);
    			attr_dev(button3, "class", "sidebar-buttons fadein-6s svelte-jta4um");
    			add_location(button3, file, 22, 73, 1189);
    			attr_dev(span4, "data-text", "Development process");
    			attr_dev(span4, "class", "tooltip-sidebar-laptop svelte-jta4um");
    			add_location(span4, file, 22, 4, 1120);
    			attr_dev(div4, "class", "sidebar svelte-jta4um");
    			add_location(div4, file, 18, 3, 666);
    			attr_dev(div5, "class", "sidebar-bottom noselect svelte-jta4um");
    			add_location(div5, file, 15, 2, 376);
    			attr_dev(div6, "class", "secondary-field noselect svelte-jta4um");
    			add_location(div6, file, 25, 2, 1297);
    			attr_dev(div7, "class", "main-content");
    			add_location(div7, file, 28, 4, 1421);
    			attr_dev(div8, "class", "main-field-container svelte-jta4um");
    			add_location(div8, file, 27, 3, 1382);
    			attr_dev(div9, "class", "main-field noselect svelte-jta4um");
    			add_location(div9, file, 26, 2, 1345);
    			attr_dev(div10, "class", "sidebar-right-bottom noselect svelte-jta4um");
    			add_location(div10, file, 33, 2, 1481);
    			attr_dev(i4, "class", "fa fa-gear");
    			add_location(i4, file, 35, 45, 1617);
    			attr_dev(button4, "class", "sidebar-buttons fadein-6s svelte-jta4um");
    			add_location(button4, file, 35, 3, 1575);
    			attr_dev(div11, "class", "bottombar-left noselect svelte-jta4um");
    			add_location(div11, file, 34, 2, 1534);
    			attr_dev(img1, "class", "profilepicture fadein-6s svelte-jta4um");
    			...
    			add_location(img1, file, 39, 4, 1753);
    			attr_dev(div12, "class", "profilepicture-container svelte-jta4um");
    			add_location(div12, file, 38, 3, 1710);
    			attr_dev(h4, "class", "username-profile-field svelte-jta4um");
    			add_location(h4, file, 42, 4, 1961);
    			attr_dev(h5, "class", "username-id-field svelte-jta4um");
    			add_location(h5, file, 43, 4, 2012);
    			attr_dev(div13, "class", "profile-info fadein-6s svelte-jta4um");
    			add_location(div13, file, 41, 3, 1920);
    			attr_dev(div14, "class", "bottombar-secondary noselect svelte-jta4um");
    			add_location(div14, file, 37, 2, 1664);
    			attr_dev(div15, "class", "bottombar-main noselect svelte-jta4um");
    			add_location(div15, file, 46, 2, 2074);
    			attr_dev(div16, "class", "bottombar-right noselect svelte-jta4um");
    			add_location(div16, file, 47, 2, 2122);
    			attr_dev(body, "onload", "startTime()");
    			attr_dev(body, "class", "layout fadein-2s svelte-jta4um");
    			add_location(body, file, 6, 1, 62);
    			attr_dev(main, "class", "svelte-jta4um");
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*name*/ 1) set_data_dev(t19, /*name*/ ctx[0]);
    			if (dirty & /*id*/ 2) set_data_dev(t22, /*id*/ ctx[1]);
    		},
    		i: noop,
    		o: noop,
