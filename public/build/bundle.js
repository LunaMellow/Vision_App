    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div38 = element("div");
    			div35 = element("div");
    			div35.textContent = "Box 1";
    			t101 = space();
    			div36 = element("div");
    			div36.textContent = "Box 2";
    			t103 = space();
    			div37 = element("div");
    			div37.textContent = "Box 3";
    			t105 = space();
    			div42 = element("div");
    			div42.textContent = "8";
    			t107 = space();
    			...
    			t114 = space();
    			div47 = element("div");
    			div47.textContent = "11";
    			t116 = space();
    			div48 = element("div");
    			div48.textContent = "12";
    			attr_dev(div0, "class", "sidebar-top noselect svelte-10kt03p");
    			add_location(div0, file, 13, 3, 448);
    			attr_dev(h3, "id", "incoming-header");
    			attr_dev(h3, "class", "svelte-10kt03p");
    			add_location(h3, file, 17, 5, 600);
    			attr_dev(h40, "class", "item-name svelte-10kt03p");
    			add_location(h40, file, 21, 8, 723);
    			attr_dev(h60, "class", "item-name color-grey svelte-10kt03p");
    			add_location(h60, file, 22, 8, 768);
    			attr_dev(h61, "class", "item-message svelte-10kt03p");
    			add_location(h61, file, 23, 8, 824);
    			attr_dev(div1, "class", "item-text svelte-10kt03p");
    			add_location(div1, file, 20, 7, 691);
    			attr_dev(div2, "class", "items svelte-10kt03p");
    			add_location(div2, file, 19, 6, 664);
    			add_location(li0, file, 18, 5, 653);
    			attr_dev(h41, "class", "item-name svelte-10kt03p");
    			add_location(h41, file, 30, 8, 988);
    			attr_dev(h62, "class", "item-name color-grey svelte-10kt03p");
    			add_location(h62, file, 31, 8, 1039);
    			attr_dev(h63, "class", "item-message svelte-10kt03p");
    			add_location(h63, file, 32, 8, 1107);
    			attr_dev(div3, "class", "item-text svelte-10kt03p");
    			add_location(div3, file, 29, 7, 956);
    			attr_dev(div4, "class", "items svelte-10kt03p");
    			add_location(div4, file, 28, 6, 929);
    			add_location(li1, file, 27, 5, 918);
    			attr_dev(h42, "class", "item-name svelte-10kt03p");
    			add_location(h42, file, 39, 8, 1269);
    			attr_dev(h64, "class", "item-name color-grey svelte-10kt03p");
    			add_location(h64, file, 40, 8, 1316);
    			attr_dev(h65, "class", "item-message svelte-10kt03p");
    			add_location(h65, file, 41, 8, 1370);
    			attr_dev(div5, "class", "item-text svelte-10kt03p");
    			add_location(div5, file, 38, 7, 1237);
    			attr_dev(div6, "class", "items svelte-10kt03p");
    			add_location(div6, file, 37, 6, 1210);
    			add_location(li2, file, 36, 5, 1199);
    			attr_dev(h43, "class", "item-name svelte-10kt03p");
    			add_location(h43, file, 48, 8, 1533);
    			attr_dev(h66, "class", "item-name color-grey svelte-10kt03p");
    			add_location(h66, file, 49, 8, 1579);
    			attr_dev(h67, "class", "item-message svelte-10kt03p");
    			add_location(h67, file, 50, 8, 1644);
    			attr_dev(div7, "class", "item-text svelte-10kt03p");
    			add_location(div7, file, 47, 7, 1501);
    			attr_dev(div8, "class", "items svelte-10kt03p");
    			add_location(div8, file, 46, 6, 1474);
    			add_location(li3, file, 45, 5, 1463);
    			attr_dev(h44, "class", "item-name svelte-10kt03p");
    			add_location(h44, file, 57, 8, 1822);
    			attr_dev(h68, "class", "item-name color-grey svelte-10kt03p");
    			add_location(h68, file, 58, 8, 1862);
    			attr_dev(h69, "class", "item-message svelte-10kt03p");
    			add_location(h69, file, 59, 8, 1917);
    			attr_dev(div9, "class", "item-text svelte-10kt03p");
    			add_location(div9, file, 56, 7, 1790);
    			attr_dev(div10, "class", "items svelte-10kt03p");
    			add_location(div10, file, 55, 6, 1763);
    			add_location(li4, file, 54, 5, 1752);
    			attr_dev(h45, "class", "item-name svelte-10kt03p");
    			add_location(h45, file, 66, 8, 2079);
    			attr_dev(h610, "class", "item-name color-grey svelte-10kt03p");
    			add_location(h610, file, 67, 8, 2119);
    			attr_dev(h611, "class", "item-message svelte-10kt03p");
    			add_location(h611, file, 68, 8, 2176);
    			attr_dev(div11, "class", "item-text svelte-10kt03p");
    			add_location(div11, file, 65, 7, 2047);
    			attr_dev(div12, "class", "items svelte-10kt03p");
    			add_location(div12, file, 64, 6, 2020);
    			add_location(li5, file, 63, 5, 2009);
    			attr_dev(h46, "class", "item-name svelte-10kt03p");
    			add_location(h46, file, 75, 8, 2341);
    			set_style(span0, "font-weight", "bold");
    			add_location(span0, file, 76, 41, 2416);
    			attr_dev(h612, "class", "item-name color-grey svelte-10kt03p");
    			add_location(h612, file, 76, 8, 2383);
    			attr_dev(h613, "class", "item-message svelte-10kt03p");
    			add_location(h613, file, 77, 8, 2486);
    			attr_dev(div13, "class", "item-text svelte-10kt03p");
    			add_location(div13, file, 74, 7, 2309);
    			attr_dev(div14, "class", "items svelte-10kt03p");
    			add_location(div14, file, 73, 6, 2282);
    			add_location(li6, file, 72, 5, 2271);
    			attr_dev(h47, "class", "item-name svelte-10kt03p");
    			add_location(h47, file, 84, 8, 2667);
    			attr_dev(h614, "class", "item-name color-grey svelte-10kt03p");
    			add_location(h614, file, 85, 8, 2717);
    			attr_dev(h615, "class", "item-message svelte-10kt03p");
    			add_location(h615, file, 86, 8, 2796);
    			attr_dev(div15, "class", "item-text svelte-10kt03p");
    			add_location(div15, file, 83, 7, 2635);
    			attr_dev(div16, "class", "items svelte-10kt03p");
    			add_location(div16, file, 82, 6, 2608);
    			add_location(li7, file, 81, 5, 2597);
    			attr_dev(ul, "class", "cards fadein-2s svelte-10kt03p");
    			set_style(ul, "overflow-y", "scroll");
    			add_location(ul, file, 16, 4, 539);
    			attr_dev(div17, "class", "secondary-field noselect svelte-10kt03p");
    			add_location(div17, file, 15, 3, 496);
    			attr_dev(h616, "id", "app-version");
    			attr_dev(h616, "class", "svelte-10kt03p");
    			add_location(h616, file, 94, 4, 3022);
    			attr_dev(div18, "class", "searchbar noselect svelte-10kt03p");
    			add_location(div18, file, 92, 3, 2913);
    			attr_dev(div19, "class", "navigation-top noselect svelte-10kt03p");
    			add_location(div19, file, 96, 3, 3074);
    			attr_dev(div20, "class", "sidebar-right noselect svelte-10kt03p");
    			add_location(div20, file, 98, 3, 3125);
    			attr_dev(img0, "class", "logo svelte-10kt03p");
    			...
    			attr_dev(img1, "class", "social-icon svelte-10kt03p");
    			...
    			attr_dev(img2, "class", "social-icon social-icon-gap svelte-10kt03p");
    			...
    			attr_dev(img3, "class", "social-icon social-icon-gap svelte-10kt03p");
    			...
    			attr_dev(img4, "class", "social-icon social-icon-gap svelte-10kt03p");
    			...
    			attr_dev(img5, "class", "social-icon social-icon-gap svelte-10kt03p");
    			...
    			attr_dev(div25, "class", "socials svelte-10kt03p");
    			add_location(div25, file, 120, 7, 4668);
    			attr_dev(div26, "class", "main-top-right main-box svelte-10kt03p");
    			add_location(div26, file, 119, 6, 4480);
    			attr_dev(img6, "class", "slideshow svelte-10kt03p");
    			...
    			attr_dev(img7, "class", "slideshow svelte-10kt03p");
    			...
    			attr_dev(img8, "class", "slideshow svelte-10kt03p");
    			...
    			attr_dev(img9, "class", "slideshow svelte-10kt03p");
    			...
    			attr_dev(img10, "class", "slideshow svelte-10kt03p");
    			...
    			attr_dev(img11, "class", "slideshow svelte-10kt03p");
    			...
    			attr_dev(img12, "class", "slideshow svelte-10kt03p");
    			...
    			attr_dev(img13, "class", "slideshow svelte-10kt03p");
    			...
    			attr_dev(div27, "class", "wrapper svelte-10kt03p");
    			add_location(div27, file, 129, 7, 5967);
    			attr_dev(div28, "class", "main-middle-left main-box svelte-10kt03p");
    			add_location(div28, file, 128, 6, 5920);
    			attr_dev(h2, "id", "news-header");
    			attr_dev(h2, "class", "svelte-10kt03p");
    			add_location(h2, file, 142, 8, 7133);
    			attr_dev(span6, "class", "gradient svelte-10kt03p");
    			add_location(span6, file, 144, 45, 7240);
    			attr_dev(h49, "class", "news-under-title svelte-10kt03p");
    			add_location(h49, file, 144, 9, 7204);
    			attr_dev(span7, "class", "gradient svelte-10kt03p");
    			add_location(span7, file, 145, 46, 7340);
    			attr_dev(h617, "class", "news-under-description svelte-10kt03p");
    			add_location(h617, file, 145, 9, 7303);
    			attr_dev(div29, "class", "articles svelte-10kt03p");
    			add_location(div29, file, 143, 8, 7172);
    			attr_dev(h410, "class", "news-under-title svelte-10kt03p");
    			add_location(h410, file, 148, 9, 7513);
    			attr_dev(h618, "class", "news-under-description svelte-10kt03p");
    			add_location(h618, file, 149, 9, 7576);
    			attr_dev(div30, "class", "articles svelte-10kt03p");
    			add_location(div30, file, 147, 8, 7481);
    			attr_dev(h411, "class", "news-under-title svelte-10kt03p");
    			add_location(h411, file, 152, 9, 7752);
    			attr_dev(h619, "class", "news-under-description svelte-10kt03p");
    			add_location(h619, file, 153, 9, 7830);
    			attr_dev(div31, "class", "articles svelte-10kt03p");
    			add_location(div31, file, 151, 8, 7720);
    			attr_dev(h412, "class", "news-under-title svelte-10kt03p");
    			add_location(h412, file, 156, 9, 8006);
    			attr_dev(h620, "class", "news-under-description svelte-10kt03p");
    			set_style(h620, "margin-bottom", "1vh");
    			add_location(h620, file, 157, 9, 8073);
    			attr_dev(div32, "class", "articles svelte-10kt03p");
    			add_location(div32, file, 155, 8, 7974);
    			attr_dev(div33, "class", "news svelte-10kt03p");
    			add_location(div33, file, 141, 7, 7106);
    			attr_dev(div34, "class", "main-middle-right main-box svelte-10kt03p");
    			add_location(div34, file, 140, 6, 7058);
    			attr_dev(div35, "class", "bottom-cards svelte-10kt03p");
    			add_location(div35, file, 163, 7, 8403);
    			attr_dev(div36, "class", "bottom-cards svelte-10kt03p");
    			add_location(div36, file, 166, 7, 8465);
    			attr_dev(div37, "class", "bottom-cards svelte-10kt03p");
    			add_location(div37, file, 169, 7, 8527);
    			attr_dev(div38, "class", "main-bottom-bar svelte-10kt03p");
    			add_location(div38, file, 162, 6, 8366);
    			attr_dev(div39, "class", "main-bottom main-box svelte-10kt03p");
    			add_location(div39, file, 161, 6, 8325);
    			attr_dev(div40, "class", "main-content svelte-10kt03p");
    			add_location(div40, file, 112, 5, 4235);
    			attr_dev(div41, "class", "main-field-container svelte-10kt03p");
    			add_location(div41, file, 111, 4, 4195);
    			attr_dev(div42, "class", "sidebar-right-bottom noselect svelte-10kt03p");
    			add_location(div42, file, 176, 3, 8631);
    			attr_dev(i4, "class", "fa fa-gear");
    			add_location(i4, file, 178, 71, 8794);
    			attr_dev(button4, "class", "sidebar-buttons fadein-6s svelte-10kt03p");
    			attr_dev(button4, "onclick", "showSettings()");
    			add_location(button4, file, 178, 4, 8727);
    			attr_dev(div43, "class", "bottombar-left noselect svelte-10kt03p");
    			add_location(div43, file, 177, 3, 8685);
    			attr_dev(img14, "class", "profilepicture fadein-6s svelte-10kt03p");
    			...
    			add_location(img14, file, 182, 5, 8934);
    			attr_dev(div44, "class", "profilepicture-container svelte-10kt03p");
    			add_location(div44, file, 181, 4, 8890);
    			attr_dev(h413, "class", "username-profile-field svelte-10kt03p");
    			add_location(h413, file, 185, 5, 9145);
    			attr_dev(h5, "class", "username-id-field svelte-10kt03p");
    			add_location(h5, file, 186, 5, 9197);
    			attr_dev(div45, "class", "profile-info fadein-6s svelte-10kt03p");
    			add_location(div45, file, 184, 4, 9103);
    			attr_dev(div46, "class", "bottombar-secondary noselect svelte-10kt03p");
    			add_location(div46, file, 180, 3, 8843);
    			attr_dev(div47, "class", "bottombar-main noselect svelte-10kt03p");
    			add_location(div47, file, 189, 3, 9262);
    			attr_dev(div48, "class", "bottombar-right noselect svelte-10kt03p");
    			add_location(div48, file, 190, 3, 9311);
    			attr_dev(div49, "class", "main-field noselect svelte-10kt03p");
    			add_location(div49, file, 110, 3, 4157);
    			attr_dev(body, "onload", "loadingAnimation()");
    			attr_dev(body, "class", "layout fadein-2s svelte-10kt03p");
    			add_location(body, file, 10, 1, 151);
    			attr_dev(main, "class", "svelte-10kt03p");
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(div44, img14);
    			append_dev(div46, t109);
    			append_dev(div46, div45);
    			append_dev(div45, h413);
    			append_dev(h413, t110);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*name*/ 1) set_data_dev(t110, /*name*/ ctx[0]);
    			if (dirty & /*id*/ 2) set_data_dev(t113, /*id*/ ctx[1]);
    		},
    		i: noop,
    		o: noop,
